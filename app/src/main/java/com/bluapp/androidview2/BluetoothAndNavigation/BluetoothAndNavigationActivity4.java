...
public class BluetoothAndNavigationActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bluetooth_and_navigation4);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (inputLayout.getEditText().getText().toString().equals("")) {
                    Toast.makeText(BluetoothAndNavigationActivity4.this, "Please input some texts", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void showPrinterPickDialog() {
        ...
        dialog.setContentView(R.layout.bluetooth_layout4);
