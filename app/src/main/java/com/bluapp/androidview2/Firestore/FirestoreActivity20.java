...
public class FirestoreActivity20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firestore20);
    ...
    private void saveDocument(String strTitle, String strBody){
        ...
        batch.commit().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(FirestoreActivity20.this,"Document Inserted",Toast.LENGTH_LONG).show();
            }
        })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(FirestoreActivity20.this,e.getMessage(),Toast.LENGTH_LONG).show();
