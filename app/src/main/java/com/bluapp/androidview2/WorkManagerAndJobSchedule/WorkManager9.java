...
public class WorkManager9 extends Worker {
    public WorkManager9(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        showNotification("Inducesmile", "First worker completed");
