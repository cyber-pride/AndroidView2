...
public class FirebaseActivity17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firebase17);
        title = (TextView)findViewById(R.id.title);
        body = (TextView)findViewById(R.id.body);
        mDatabase = FirebaseDatabase.getInstance().getReference().child("AndroidView");
        Query query = mDatabase.orderByChild("title").equalTo("hello");
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(FirebaseActivity17.this,databaseError.getMessage(),Toast.LENGTH_LONG).show();
            }
        });
    }
}
