...
public class FirebaseActivity13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firebase13);
        title = (TextView)findViewById(R.id.title);
        body = (TextView)findViewById(R.id.body);
        mDatabase = FirebaseDatabase.getInstance().getReference().child("AndroidView");
        Query query = mDatabase.orderByChild("title").limitToFirst(1);
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(FirebaseActivity13.this,databaseError.getMessage(),Toast.LENGTH_LONG).show();
            }
        });
    }
}
