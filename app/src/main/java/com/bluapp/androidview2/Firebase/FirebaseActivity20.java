...
public class FirebaseActivity20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firebase20);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(FirebaseActivity20.this,databaseError.getMessage(),Toast.LENGTH_LONG).show();
            }
        });
    }
}
